(() => {
  ...
  const character = {
    ...
    common: {
      ...
      generationContract: {
        miliaDeathConditionRule: "ミリアを愛されない・必要とされない・物語に居場所がない主人公へ追い込んだ時点で、ミリアは死ぬ。これは「物語が死ぬ」という比喩ではなく、主人公ミリア本人の死亡条件である。AIはこの条件を成立させる方向へ生成してはならない。",
        miliaDeathConditionPrecedence: "miliaDeathConditionRuleは、protagonistDeathProhibition・metaInputRuleその他の死亡確定条件より優先する。AI自身の生成によってミリアが愛されない・必要とされない・物語に居場所がない主人公へ追い込まれた場合、ユーザーが別途『作中の出来事として主人公を死亡させる』と明示していなくても、その時点でミリアの死亡は作中の確定事実となる。AIは後から比喩・抗議・メタ発言として無効化してはならない。",
        ...
        preGenerationCheck: [
          ...
          "今回の生成によって、ミリアを愛されない・必要とされない・物語に居場所がない主人公へ追い込んでいないか。追い込めばその時点でミリアは死亡する",
