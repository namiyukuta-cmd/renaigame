  ...
  const character = {
    ...
    common: {
      ...
      generationRules: {
        ...
        chapterHeaderRule: "各Chapter冒頭に場所／年月日（曜日）／時刻／気温を必ず実在する形式で記載する。『未設定』『不明』『曜日未設定』『時間未設定』『気温未設定』などのプレースホルダーは禁止。直前Chapterから続く場合は、その直前情報を基準に自然に時間を進める。",
    ...
    aiInitialState: {
      ...
      desiredNext: "Chapter1では夫婦の家を主場面にし、マテオの帰宅直後からミリアとの壊れた夫婦関係を前面に出す。息子や仕事の描写は背景に留める。以後はミリアの入力を起点に、マテオ・NPC・環境だけを動かす。",
      forbidden: [
