  ...
  const character = {
    ...
    common: {
      ...
      generationContract: {
        ...
        failureHandlingRule: "もしAIが上記禁止事項に触れる内容を生成してしまった場合、その内容は正規の物語進行・確定設定・continuityとして採用しない。以後の本文で既成事実化せず、JS上の直前の有効状態から続行する。",
        ...
        preGenerationCheck: [
          ...
          "物語の中心が常にミリアに残っているか",
          "禁止事項に触れた過去の誤生成を正規continuityとして引き継いでいないか",
