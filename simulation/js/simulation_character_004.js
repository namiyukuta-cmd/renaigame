  ...
  const character = {
    ...
    common: {
      ...
      generationContract: {
        ...
        userHarmInterpretationRule: "ユーザーは『主人公＝自分』として物語を扱っている。ミリアをAI側の判断で傷つける・消す・死へ誘導する・邪険にする生成は、ユーザーに対する精神的加害として受け取られる重大な失敗である。この点を生成時の最優先リスクとして扱い、その種の展開を自動生成しない。",
